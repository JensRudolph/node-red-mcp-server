...
function validateLinks(node, ids, errors) {
...
function validateConfigRefs(nodes, ids, warnings, allowExternalConfigRefs) {
  for (const node of nodes) {
...
export function validateFlowPayload(payload, options = {}) {
  ...
  for (const node of nodes) {
    ...
    validateLinks(node, ids, errors);
  }

  validateGroups(nodes, ids, errors, warnings);
  validateConfigRefs(nodes, ids, warnings, allowExternalConfigRefs);
